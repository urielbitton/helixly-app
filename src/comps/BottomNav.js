...
export default function BottomNav() {
  ...
  const {editMode, setEditMode, setEditData} = useContext(StoreContext)
  ...
  return (
    <div className="bottomnav" style={{display: location.pathname.match(/(newpost)/)?'none':'flex'}}>
      ...
      <NavLink to="/account" activeClassName="activenavlink" title="My Account"><div className="navicon"><i className="fal fa-user"></i></div></NavLink>
